...
public class HttpUtil {
    public static String sendGet(String url){
        ...
        try {
            ...
            conn.setRequestProperty("Cookie", ClientConstant.CONS_INFO.get(3));
            br = new BufferedReader(new InputStreamReader(conn.getInputStream(), StandardCharsets.UTF_8));
            String temp;
            while ((temp = br.readLine()) != null) {
                result.append(temp);
            }
            System.out.println("=======status======="+conn.getHeaderField("Set-Cookie"));
    ...
    public static String sendPostOnJson(String url, String jsonString) {
        ...
        try {
            ...
            connection.setRequestProperty("Cookie", ClientConstant.CONS_INFO.get(3));
